                                ...
                                <table className="w-100">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style={{
                                                height: '40px',
                                            }} className="text-end text-secondary fw-bold" > 5.000 ₫</td>
                                        </tr>
                                        <tr>
                                            <td><hr /></td>
                                            <td><hr /></td>
                                        ...
                                        <tr>
                                            ...
                                            <td className="text-end text-secondary text-danger fw-bold fs-5" >{(totalPayment ? totalPayment + 5000 : 0).toLocaleString(
                                                "vi-VN",
                                                { style: "currency", currency: "VND" }
                                            )}</td>
                                        </tr>
